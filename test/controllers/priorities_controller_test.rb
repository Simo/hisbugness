...
class PrioritiesControllerTest < ActionController::TestCase
  ...
  test "should create priority" do
    assert_difference('Priority.count') do
      post :create, priority: { color: @priority.color, description: @priority.description, image: @priority.image, issue_id: @priority.issue_id }
    end
  ...
  test "should update priority" do
    patch :update, id: @priority, priority: { color: @priority.color, description: @priority.description, image: @priority.image, issue_id: @priority.issue_id }
    assert_redirected_to priority_path(assigns(:priority))
  end
