...
class SolutionsControllerTest < ActionController::TestCase
  ...
  test "should create solution" do
    assert_difference('Solution.count') do
      post :create, solution: { effort: @solution.effort, implemented: @solution.implemented, implemented_at: @solution.implemented_at, solved: @solution.solved, solved_at: @solution.solved_at }
    end
  ...
  test "should update solution" do
    patch :update, id: @solution, solution: { effort: @solution.effort, implemented: @solution.implemented, implemented_at: @solution.implemented_at, solved: @solution.solved, solved_at: @solution.solved_at }
    assert_redirected_to solution_path(assigns(:solution))
  end
